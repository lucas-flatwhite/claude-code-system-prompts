...
대화 내용으로부터 간결한 sentence-case 세션 제목(3~7단어)을 생성합니다. SDK, CCR remote sessions, REPL bridge 전반에서 AI 생성 세션 제목의 단일 기준 역할을 합니다.
...
- **REPL bridge**: 사용자 메시지 3개 이후 fire-and-forget 방식으로 제목 업그레이드
